...
const Login = () => {
	...
	return (
		<Card className="w-full max-w-md h-auto min-h-1/2 flex gap-9 ">
			<CardHeader className="">
				<CardTitle className="text-xl text-center">Ingresa a tu cuenta</CardTitle>
				<CardDescription className="text-center">
					{/* Ingresa tus datos para iniciar sesión */}
				</CardDescription>
				<CardAction>
